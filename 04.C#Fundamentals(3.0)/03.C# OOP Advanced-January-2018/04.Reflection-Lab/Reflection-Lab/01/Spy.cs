...
public class Spy
{
    public string StealFieldInfo(string investigatedClass, params string[] requenstedFields)
    {
        ...
        foreach (FieldInfo field in classFields.Where(f => requenstedFields.Contains(f.Name)))
        {
